...
const testimonials = [
  {
    ...
    text: "I bought my first car with crypto, and Satoshi Drive made it flawless. Funds verified, paperwork completed, and handover done on the spot. Couldn’t be easier.",
    user: "Tunde Adeboye",
    avatar: avatar,
  },
  {
